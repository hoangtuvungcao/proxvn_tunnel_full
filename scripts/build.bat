...
%USERPROFILE%\go\bin\rsrc.exe -ico src\backend\cmd\client\proxvn.ico -o src\backend\cmd\client\rsrc_windows.syso
%USERPROFILE%\go\bin\rsrc.exe -ico src\backend\cmd\server\proxvn.ico -o src\backend\cmd\server\rsrc_windows.syso
cd src\backend
set GOOS=windows
set GOARCH=amd64
